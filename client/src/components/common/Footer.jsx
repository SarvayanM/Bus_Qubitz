  ...
  return (
    <footer className="bg-[#F9FAFB] border-t border-[#2563EB]/20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 pb-10">
          {/* Brand Section */}
          <div className="md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <h2 className="text-2xl font-bold text-[#2563EB]">leoforeio</h2>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-[#2563EB] mb-5">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 text-[#2563EB] mt-1">
