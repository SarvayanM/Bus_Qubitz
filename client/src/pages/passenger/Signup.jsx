  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      document.cookie = `email=${encodeURIComponent(
        user.email || ""
      )}; ${secure}path=/; max-age=86400; SameSite=Lax`;
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB] px-4 py-8">
        ...
        <div className="relative w-full max-w-md bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden z-10 border border-[#2563EB]/10">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-3 text-[#2563EB] font-medium text-sm hover:text-[#16A34A] transition-colors"
            ...
            <div className="text-center">
              <button
                ...
                className="text-[#2563EB] font-semibold hover:text-[#16A34A] text-lg hover:underline transition duration-200 px-4 py-2 rounded-lg bg-[#F9FAFB] border border-gray-200 hover:border-[#2563EB]/30 w-full cursor-pointer"
              >
          ...
          {/* Footer */}
          <div className="px-8 pb-8 text-center pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-600">
              By registering, you agree to our{" "}
              <a
                href="#"
                className="text-[#2563EB] hover:text-[#16A34A] font-semibold underline"
              >
                Terms of Service
              </a>{" "}
              and{" "}
